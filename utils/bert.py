...
class BertPreTrainingHeads(nn.Module):
    ...
    def __init__(self, config, bert_model_embedding_weights):
        ...
        self.seq_relationship = nn.Linear(config.hidden_size, 20)
...
class BertForEmoji(nn.Module):

    def __init__(self, net_bert):
        super(BertForEmoji, self).__init__()
        ...
        self.cls = nn.Linear(in_features=768, out_features=20)
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, output_all_encoded_layers=False, attention_show_flg=False):
        ...
        print("output_all_encoded_layers=", output_all_encoded_layers)
        print("attention_show_flg=", attention_show_flg)
        """
